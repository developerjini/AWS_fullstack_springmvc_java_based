...
<head>
<meta charset="UTF-8">
<title>2023. 4. 11.오전 10:35:20</title>
<style>
...
<body>
	...
	$(function() {
		var ws = new WebSocket("ws://localhost/controller/note");
...
/* 			noteService.get(1, function(data) {
			...
			noteService.getReceiveCheckedList(sender, function(data) {
			    console.log("getReceivedCheckedList")
			    console.log(data)
